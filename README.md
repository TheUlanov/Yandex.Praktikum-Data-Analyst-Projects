...
<table width=100% valign=top >
  <tr>
    ...
    <td>Python, Pandas, Matplotlib.pyplot, Plotly.express, Seaborn, Map, Marker, Choropleth, MarkerCluster </td>
  </tr>
...
After that, examine the results of the A/A/B experiment. Designers wanted to change fonts throughout the application, and managers were afraid that users would be unusual. We agreed to make a decision based on the results of the A/A/B test.</td>
    <td>Python, Pandas, Datetime, Seaborn, Matplotlib.pyplot, Plotly, Numpy, Scipy, Scipy.stats, Math  </td>
  </tr>
  <tr>
    ...
    <td>Python, Pandas, Datetime, Scipy.stats, Numpy, Matplotlib.pyplot, Register_matplotlib_converters, Warnings</td>
  </tr>
...
<tr>
    ...
    <td>Python, Pandas, Numpy, Datetime, Matplotlib, </td>
  </tr>
<tr>
    ...
    <td>Python, Pandas, Matplotlib.pyplot, Stats, Numpy</td>
  </tr>
...
<tr>
    ...
    <td>Python, Pandas, Numpy, Stats, Seaborn, Matplotlib.pyplot  </td>
  </tr>
  <tr>
    ...
    <td>Python, Pandas, Datetime, Matplotlib.pyplot, Matplotlib</td>
  </tr>
  <tr>
